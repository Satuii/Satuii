...
<html>
    ...
    <body>
        ...
        <div class="produk">
            <img src="flowers279583_1920.jpg" width="40%" height="10%" alt="Bunga Mawar">
            <h3>Bunga Mawar</h3>
            <p>Harga: RM 10.00</p>
            <button onclick="tambahKeTroli()">Tambahan ke Troli</button>
        </div>
        <div class="produk">
            <img src="64252a3c37cbd.jpg" width="40%" height="10%" alt="Bunga Anggrek">
            <h3>Bunga Anggrek</h3>
            <p>Harga: RM 15.00</p>
